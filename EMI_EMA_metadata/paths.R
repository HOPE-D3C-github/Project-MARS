...
path_to_input_data_from_jamie <- paste0(pre_box, 'Box/MARS Curation Workspace/EMA/Release v1.0.0/Inputs/2023-09-05_data_from_jamie')
path_to_other_input_data <- paste0(pre_box, 'Box/MARS Curation Workspace/EMA/Release v1.0.0/Inputs')

# Staged
path_to_staged <- paste0(pre_box, 'Box/MARS Curation Workspace/EMA/Release v1.0.0/Staged')

# Outputs
path_to_outputs_4_analysis <- paste0(pre_box, 'Box/MARS Curated Data/EMA/Release v1.0.0')
path_to_outputs_4_datamanagers <- paste0(pre_box, 'Box/MARS Curation Workspace/EMA/Release v1.0.0')
